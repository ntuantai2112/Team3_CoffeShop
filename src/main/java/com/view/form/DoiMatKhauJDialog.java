...
public class DoiMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String us = txtTk.getText();
        String ps = txtPassOld.getText();
        String matkhauMoi3 = txtPassNew1.getText();
        String matkhauMoi4 = txtPassNew2.getText();
        ...
        try ( Connection con = connection.getConnection();  PreparedStatement st = con.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                 if(!matkhauMoi3.equalsIgnoreCase(matkhauMoi4)){
                    JOptionPane.showMessageDialog(this, "Xác nhận mật khẩu không đúng!");
                    return;
                }
                NhanVien form = new NhanVien("", matkhauMoi4);
                JOptionPane.showMessageDialog(this, service.doiMatKhau(us, form));

                 
            } else {
                String manv = txtTk.getText();
                String matkhau = txtPassOld.getText();
                String matkhauMoi = txtPassNew1.getText();
                String matkhauMoi2 = txtPassNew2.getText();
                if(!matkhauMoi.equalsIgnoreCase(matkhauMoi2)){
                    JOptionPane.showMessageDialog(this, "Xác nhận mật khẩu không đúng!");
                    return;
                    ...
                    return;
                }else if(matkhauMoi.equalsIgnoreCase("")){
                    JOptionPane.showMessageDialog(this, "Bạn chưa nhập mật khẩu mới");
                    return;
                }
                else if(matkhauMoi2.equalsIgnoreCase("")){
                    JOptionPane.showMessageDialog(this, "Bạn chưa nhập mật khẩu xác nhận");
                    return;
                }
                else{
    ...
    private boolean check() {
        if(txtTk.getText().equalsIgnoreCase("")){
            JOptionPane.showConfirmDialog(this, "Taif khoan khong dc de trong");
            return false;
        }
        return true;
    }
